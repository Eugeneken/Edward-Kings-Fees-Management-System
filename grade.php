            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
						...
						' <a href="grade.php" class="btn btn-info btn-sm pull-right" style="border-radius:0%">Go Back </a>':'<a href="grade.php?action=add" class="btn btn-info btn-sm pull-right" style="border-radius:0%"><i class="glyphicon glyphicon-plus"></i> Add New Grade </a>';
						?>
						</h1>
                             ...
                             <div class="table-sorting table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
									...
									echo '<tr>
                                            ...
                                            <td>'.$r['detail'].'</td>
											<td>
											<a href="grade.php?action=edit&id='.$r['id'].'" class="btn btn-info btn-xs" style="border-radius:60px;"><span class="glyphicon glyphicon-edit"></span></a>
