...
<form class="form-inline" role="form" id="searchform">
  <div class="form-group">
    ...
    <input type="text" cl-998
           ass="form-control" id="student" name="student">
  </div>
  ...
  <div class="form-group">
   ...
   <button type="button" class="btn btn-info btn-sm" style="border-radius:0%" id="find" > Filter </button>
