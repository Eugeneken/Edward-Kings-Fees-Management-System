...
<head>
    ...
    <title>Edward Kings Fees Management System</title>
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">You're in the dashboard!</h1>
				  ...
				  <div class="col-md-4">
                        <div class="main-box mb-purple">
                            <a href="student.php">
                                ...
                                <h4>Overall Students: <?php include 'counter/stucount.php'?></h4>
                    ...
                    <div class="col-md-4">
                        <div class="main-box mb-green">
                            <a href="fees.php">
                                ...
                                <h4>Total Amount: <?php include 'counter/totalearncount.php'?></h4>
                                <h5>Collect Fees</h5>
                            </a>
                        </div>
                    </div>
