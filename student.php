            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
						...
						' <a href="student.php" class="btn btn-info btn-sm pull-right" style="border-radius:0%">Go Back </a>':'<a href="student.php?action=add" class="btn btn-info btn-sm pull-right" style="border-radius:0%"><i class="glyphicon glyphicon-plus"></i> Add New Student</a>';
						?>
						</h1>
               ...
               <div class="panel panel-info">
						...
						<div class="form-group">
								...
								<input type="hidden" name="action" value="<?php echo $action;?>">
									...
									<button type="submit" name="save" class="btn btn-info" style="border-radius:0%">Save </button>
